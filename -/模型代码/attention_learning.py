...
def load_dataset(path,num_examples):
    pairs = creat_dataset(path,num_examples)
    ...
    target_tensor = tf.keras.preprocessing.sequence.pad_sequences(target_tensor,max_length_tar,padding='post')
...
def evaluate(sentence,encoder,decoder,inp_lang,targ_lang,max_length_inp,max_length_targ):
    ...
    inputs = tf.covert_to_tensor(inputs)
...
def translate(sentence,encoder,decoder,inp_lang,tar_lang,max_length_inp,max_length_targ):
